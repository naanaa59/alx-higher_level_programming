...
def matrix_mul(m_a, m_b):
    ...
    Args:
        m_a :list of lists of int or floats: The first matrix.
        m_b list of lists of int or floats: The second matrix.
    Raises:
        TypeError: If  m_a or m_b is not a list of lists of int orfloats.
